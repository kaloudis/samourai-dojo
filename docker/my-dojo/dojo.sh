...
start() {
  if [ "$ELECTRS_INSTALL" == "on" ]; then
    ...
    echo "# This file is dynamically generated by dojo.sh with bitcoind rpc credentials
cookie = \"$BITCOIND_RPC_USER:$BITCOIND_RPC_PASSWORD\"" > "$DIR/conf/docker-electrs.toml"
  fi
